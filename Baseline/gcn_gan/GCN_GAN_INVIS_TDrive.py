...
# ====================
data_name = 'T-Drive'
num_nodes = 1279 # Number of nodes (Level-1 w/ fixed node set)
num_snaps = 300 # Number of snapshots
max_thres = 5000 # Threshold for maximum edge weight
noise_dim = 64 # Dimension of noise input
struc_dims = [noise_dim, 128, 256] # Layer configuration of structural encoder
