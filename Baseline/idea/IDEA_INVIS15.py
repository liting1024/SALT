...
# ====================
data_name = 'INVIS15'
num_nodes_glb = int(232) # Number of nodes (Level-1 w/ fixed node set)
...
feat_dim = 12 # Dimensionality of node feature
pos_dim = 12 # Dimensionality of positional embedding
