...
# ====================
data_name = 'Thiers13'
num_nodes = 332 # Number of nodes (Level-1 w/ fixed node set)
num_snaps = 179 # Number of snapshots
max_thres = 50 # Threshold for maximum edge weight
feat_dim = 9 # Dimensionality of feature input
...
feat = np.load(f'{base_dataset_path}/{data_name}/{data_name}_feat.npy', allow_pickle=True)  # 332
